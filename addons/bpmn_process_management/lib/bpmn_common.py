...
# Colors: OMG non-normative color extension (bpmn-js 7+) and the older bpmn.io one.
...
NEUTRAL_FILLS = {"#FFFFFF"}
NEUTRAL_STROKES = {"#000000"}


def norm_color(value, neutral=()):
    """'#abc' / '#aabbcc' -> '#AABBCC'; None for anything else (none, default,
    gradients, theme formulas) and for the given neutral (default) colors."""
    v = (value or "").strip()
    if _HEX3.match(v):
