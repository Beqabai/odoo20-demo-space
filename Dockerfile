...
# გაშვება შექმნილი odoouser როლით
CMD ["sh", "-c", "python3 /opt/odoo/odoo-bin --http-port=10000 --db_host=db.hyfcefsvjnjmuxofmwfv.supabase.co --db_port=5432 --db_user=odoouser --db_password=odoo12345password -d postgres --addons-path=/opt/odoo/addons,/mnt/extra-addons"]
